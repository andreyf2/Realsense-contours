...
#include </Docs/cv-helpers.hpp>    // Helper functions for conversions between RealSense and OpenCV
#include <opencv/cv.h>
  ...
  for( int i = 0; i< contours.size(); i++ )
     {
       ...
       drawContours( color_mat, contours, i, color, 8, 8, hierarchy, 0, Point() );
     }
